...
namespace UnityEditor
{
    public class ReorderableList
    {
        ...
        private const float ElementEdgeBottom = 3;
        private const float ElementHeightOffset = ElementEdgeTop + ElementEdgeBottom;
        ...
        private float GetElementHeight(SerializedProperty element)
        {
            ...
            {
                return EditorGUI.GetPropertyHeight(element, GetElementLabel(element, elementLabels), IsElementExpandable(element)) + ElementHeightOffset;
            }
        }
